...
#else
        [DllImport(@"hqchart.csharp.dll", EntryPoint = "Run")]
#endif
...
#else
        [DllImport(@"hqchart.csharp.dll", EntryPoint = "MainVersion")]
#endif
...
#else
        [DllImport(@"hqchart.csharp.dll", EntryPoint = "MinVersion")]
#endif
...
#else
        [DllImport(@"hqchart.csharp.dll", EntryPoint = "GetAuthorizeInfo", CharSet = CharSet.Unicode)]
#endif
        public static extern System.IntPtr GetAuthorizeInfo();
